...
import cn.edu.jsu.mx.dao.XmDAO;

public class Excelinterformation {
	public static void main(String[] agrs) {
		Vector<Vector> vec=new XmDAO().getTableRows("select * from xm");
    	File file =new File("D:\\gly\\hhh.xlsx");
